...
3. Читає Day 1 → у кінці бачить "Завершальний код: STEZHKA"
4. Йде на Day 2, який заблокований → вводить STEZHKA → розблоковує
5. ...і так далі до Day 7
6. Day 7 завершується кодом VERSHYNA — мітка про пройдений челендж
